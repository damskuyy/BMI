...
<div class="slider-area slider-mobile">
    <div class="slider-active-mobile">
        <div class="single-slider hero-overly slider-height-mobile d-flex align-items-center" data-background="fe/img/hero/bg1.png">
                    ...
                    <div class="col-12">
                        <div class="hero__caption hero-mobile-caption">
                            ...
                            {{-- <div class="stock-text">
                                <h2 class="text-outline">Bogor</h2>
                            </div> --}}
                            ...
                            {{-- <div class="stock-text mt-1">
                                <h2 class="text-outline">Indonesia</h2>
                            </div> --}}
                        </div>
                    </div>
                </div>
